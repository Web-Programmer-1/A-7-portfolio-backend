...
import { createProject, deleteProjectData, getAllProjects, getProjectById,  getProjectByIdController,  updateProject } from "./project.controller";
...
projectRoute.get("/top", authenticateJWT, authorizeRoles("USER"), getProjectByIdController);
